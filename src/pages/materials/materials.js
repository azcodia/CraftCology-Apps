...
class MaterialPages extends Component {
    ...
    return(
      <View style={styles.container}>
        ...
        <FlatList
          ...
          renderItem={({item}) => <ItemCard item={item} kategory="Materials" />}
...
export default connect(mapStateToProps, mapDispatchToProps)(MaterialPages);